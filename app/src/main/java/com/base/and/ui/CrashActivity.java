...
import com.base.and.utils.crash.CustomActivityOnCrash;
...
public final class CrashActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
                            ...
                            .setNeutralButton("复制日志",
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            Toast.makeText(CrashActivity.this, "复制成功", Toast.LENGTH_SHORT).show();
                                        }
                                    })
                            .show();
                    TextView textView = dialog.findViewById(android.R.id.message);
                    textView.setTextSize(TypedValue.COMPLEX_UNIT_PX, DensityUtil.dp2px(CrashActivity.this, 12));
                }
            });
        } else {
        ...
        Glide.with(this).asGif().load("http://5b0988e595225.cdn.sohucs.com/images/20180811/a73378df6d0b4dd5852e198a93a1c487.gif").into(errorImageView);
