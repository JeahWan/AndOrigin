...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME_POP_ACTIVITY = "PopActivity";
     ...
     * 创建对应名称的sp文件，并保存数据
     */
    public static boolean putIntBySPName(Context context, String name, String key, int value) {
     ...
     * 从指定名称的sp文件中获取数据
     */
    public static int getIntBySPName(Context context, String name, String key, int defaultValue) {
        SharedPreferences settings = context.getSharedPreferences(name,
                Context.MODE_PRIVATE);
        return settings.getInt(key, defaultValue);
    }
    ...
    /**
     * 清除指定名称的sp文件的对应key的数据
     */
    public static void removeIntBySPName(Context context, String name, String key) {
        SharedPreferences settings = context.getSharedPreferences(name,
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.remove(key);
     ...
     * 清除指定名称的sp文件的所有数据
     */
    public static void clearBySPName(Context context, String name) {
        SharedPreferences settings = context.getSharedPreferences(name,
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = settings.edit();
        editor.clear();
