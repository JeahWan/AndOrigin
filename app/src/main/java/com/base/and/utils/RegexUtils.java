...
public final class RegexUtils {
    ...
    public static boolean isMobileSimple(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_MOBILE_SIMPLE, input);
    }
    ...
    public static boolean isMobileExact(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_MOBILE_EXACT, input);
    }
    ...
    public static boolean isTel(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_TEL, input);
    }
    ...
    public static boolean isIDCard15(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_ID_CARD15, input);
    }
    ...
    public static boolean isIDCard18(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_ID_CARD18, input);
    }
    ...
    public static boolean isEmail(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_EMAIL, input);
    }
    ...
    public static boolean isURL(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_URL, input);
    }
    ...
    public static boolean isZh(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_ZH, input);
    }
    ...
    public static boolean isUsername(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_USERNAME, input);
    }
    ...
    public static boolean isDate(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_DATE, input);
    }
    ...
    public static boolean isIP(final CharSequence input) {
        return isMatch(Constants.Regex.REGEX_IP, input);
    }
    ...
    public static boolean isWechatId(String wechatId) {
        // 校验微信号正则
        String judge = "^[a-zA-Z]{1}[-_a-zA-Z0-9]{5,19}+$";
        Pattern pat = Pattern.compile(judge);
        Matcher mat = pat.matcher(wechatId);
        return mat.matches();
    }
}
